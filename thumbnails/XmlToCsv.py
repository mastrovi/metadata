...
class modifications(object):
    ...
    def aaa_replace(self):
        ...
        # url = http://content.lib.auburn.edu/digital/iiif/2/aunumphoto:32/full/300,/0/default.jpg
        ...
        url_rpl2 = url_rpl1.replace('http://content.lib.auburn.edu/cdm/ref/collection/',
                                    'http://content.lib.auburn.edu/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://content.lib.auburn.edu/cdm/ref/',
                                            'http://content.lib.auburn.edu/digital/')
        return (url, url2)

    def aar_replace(self):
        # Reformatted urls should look like:
        # url = http://digital.archives.alabama.gov/digital/iiif/2/photo:1548/full/300,/0/default.jpg
        # url2 = http://digital.archives.alabama.gov/digital/collection/photo/id/1548
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://digital.archives.alabama.gov/cdm/ref/collection/',
                                    'http://digital.archives.alabama.gov/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://digital.archives.alabama.gov/cdm/ref/',
                                            'http://digital.archives.alabama.gov/digital/')
        return (url, url2)
    ...
    def abj_replace(self):
        # Reformatted urls should look like:
        # url = http://cdm16044.contentdm.oclc.org/digital/iiif/2/BPLSB02:100/full/300,/0/default.jpg
        # url2 = http://cdm16044.contentdm.oclc.org/digital/collection/BPLSB02/id/100
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://cdm16044.contentdm.oclc.org/cdm/ref/collection/',
                                    'http://cdm16044.contentdm.oclc.org/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://cdm16044.contentdm.oclc.org/cdm/ref/',
                                            'http://cdm16044.contentdm.oclc.org/digital/')
        return (url, url2)

    # Looks like alm has turned off the ability to download and do thumbnails
    # def alm_replace(self):
    #     # Only first url modified, urls should look like:
    #     # url = https://digitalcollections.libraries.ua.edu/digital/iiif/2/p17336coll22:684/full/300,/0/default.jpg
    #     # url2 = https://digitalcollections.libraries.ua.edu/digital/collection/p17336coll22/id/684
    #     url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
    #     url_rpl2 = url_rpl1.replace('/digital/collection/', '/digital/iiif/2/')
    #     url = url_rpl2.replace('/id/', ':')
    #     url2 = self.edm_is_shown_at
    #     return (url, url2)
    ...
    def bcas_replace(self):
        # Only first url modified, urls should look like:
        # url = https://arstudies.contentdm.oclc.org/digital/iiif/2/findingaids:12453/full/300,/0/default.jpg
        # url2 = https://arstudies.contentdm.oclc.org/digital/collection/findingaids/id/12453/
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('/digital/collection/', '/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at
    ...
    def csu_replace(self):
        # Reformatted urls should look like:
        # url = http://clevelandmemory.contentdm.oclc.org/digital/iiif/2/afro:511/full/300,/0/default.jpg
        # url2 = http://clevelandmemory.contentdm.oclc.org/digital/collection/afro/id/511
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://clevelandmemory.contentdm.oclc.org/cdm/ref/collection/',
                                    'http://clevelandmemory.contentdm.oclc.org/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://clevelandmemory.contentdm.oclc.org/cdm/ref/',
                                            'http://clevelandmemory.contentdm.oclc.org/digital/')
        return (url, url2)
    ...
    def dlg_replace(self):
        ...
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url = re.sub('/record/(.*)_(.*)_(.*)#item', r'/images/iiif/2/dlg%2F\1%2F\2%2F\1_\2_\3%2F\1_\2_\3-00001.jp2',
                     url_rpl1)
        url2 = self.edm_is_shown_at
        return (url, url2)
    ...
    def fqr_replace(self):
        # Reformatted urls should look like:
        # url = http://digitalcollections.library.miami.edu/digital/iiif/2/asm0650:511/full/300,/0/default.jpg
        # url2 = http://digitalcollections.library.miami.edu/digital/collection/asm0650/id/511
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://digitalcollections.library.miami.edu/cdm/ref/collection/',
                                    'https://digitalcollections.library.miami.edu/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://digitalcollections.library.miami.edu/cdm/ref/',
    ...
    def gcl_replace(self):
        ...
        # url2 =
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://cdm17323.contentdm.oclc.org/cdm/ref/collection/',
                                    'https://cdm17323.contentdm.oclc.org/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://cdm17323.contentdm.oclc.org/cdm/ref/',
                                            'https://cdm17323.contentdm.oclc.org/digital/')
        return (url, url2)
    ...
    def geh_replace(self):
        ...
        # url2 =
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://album.atlantahistorycenter.com/cdm/ref/collection/',
                                    'https://album.atlantahistorycenter.com/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://album.atlantahistorycenter.com/cdm/ref/',
                                            'https://album.atlantahistorycenter.com/digital/')
        return (url, url2)
    ...
    def gsu_replace(self):
        # Reformatted urls should look like:
        # url = http://digitalcollections.library.gsu.edu/digital/iiif/2/gawl:511/full/300,/0/default.jpg
        # url2 = http://digitalcollections.library.gsu.edu/digital/collection/gawl/id/511
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://digitalcollections.library.gsu.edu/cdm/ref/collection/',
                                    'http://digitalcollections.library.gsu.edu/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://digitalcollections.library.gsu.edu/cdm/ref/',
                                            'http://digitalcollections.library.gsu.edu/digital/')
        return (url, url2)

    def hbcula_replace(self):
        # Reformatted urls should look like:
        # url = https://hbcudigitallibrary.auctr.edu/digital/iiif/2/nccu:0/full/300,/0/default.jpg
        # url2 = https://hbcudigitallibrary.auctr.edu/digital/collection/nccu/id/0
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://hbcudigitallibrary.auctr.edu/cdm/ref/collection/',
                                    'https://hbcudigitallibrary.auctr.edu/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://hbcudigitallibrary.auctr.edu/cdm/ref/',
    ...
    def src_replace(self):
        # Only first url modified, urls should look like:
        # url = https://localhistory.richlandlibrary.com/digital/iiif/2/p16817coll21:324/full/300,/0/default.jpg
        # url2 = https://localhistory.richlandlibrary.com/digital/collection/p16817coll21/id/324
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('https://localhistory.richlandlibrary.com/digital/collection/',
                                    'https://localhistory.richlandlibrary.com/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at
        return (url, url2)
    ...
    def suc_replace(self):
        # Reformatted urls should look like:
        # url = https://digital.tcl.sc.edu/digital/iiif/2/adamsea:12/full/300,/0/default.jpg
        # url2 = https://digital.tcl.sc.edu/digital/collection/adamsea/id/12
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('https://digital.tcl.sc.edu/digital/collection/',
                                    'https://digital.tcl.sc.edu/digital/iiif/2/')
        url_rpl3 = url_rpl2.replace('http://cdm17173.contentdm.oclc.org/cdm/ref/collection/',
                                    'https://digital.tcl.sc.edu/digital/iiif/2/')
        url_rpl4 = url_rpl3.replace('http://digital.tcl.sc.edu/cdm/ref/collection/',
                                    'https://digital.tcl.sc.edu/digital/iiif/2/')
        url = url_rpl4.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://digital.tcl.sc.edu/cdm/ref/collection/',
                                            'http://digital.tcl.sc.edu/digital/')
        return (url, url2)
    ...
    def usm_replace(self):
        ...
        url = self.edm_is_shown_at.replace("https://usm.access.preservica.com/uncategorized/",
                                           "https://usm.access.preservica.com/download/thumbnail/")
        url2 = self.edm_is_shown_at
        return (url, url2)
    ...
    def xhs_replace(self):
        # Reformatted urls should look like:
        # url = http://images.indianahistory.org/digital/iiif/2/BPLSB02:100/full/300,/0/default.jpg
        # url2 = http://images.indianahistory.org/digital/collection/BPLSB02/id/100
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://images.indianahistory.org/cdm/ref/collection/',
                                    'http://images.indianahistory.org/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://images.indianahistory.org/cdm/ref/',
                                            'http://images.indianahistory.org/digital/')
        return (url, url2)

    def wsh_replace(self):
        # Reformatted urls should look like:
        # url = http://content.wisconsinhistory.org/digital/iiif/2/BPLSB02:100/full/300,/0/default.jpg
        # url2 = http://content.wisconsinhistory.org/digital/collection/BPLSB02/id/100
        url_rpl1 = self.edm_is_shown_at + "/full/300,/0/default.jpg"
        url_rpl2 = url_rpl1.replace('http://content.wisconsinhistory.org/cdm/ref/collection/',
                                    'http://content.wisconsinhistory.org/digital/iiif/2/')
        url = url_rpl2.replace('/id/', ':')
        url2 = self.edm_is_shown_at.replace('http://content.wisconsinhistory.org/cdm/ref/',
                                            'http://content.wisconsinhistory.org/digital/')
        return (url, url2)
